package com.flightbooking.baseclass;
...
import com.flightbooking.utilities.FlightBooking_ReadConfig;


public class FlightBooking_BaseClass {

	FlightBooking_ReadConfig readconfig=new FlightBooking_ReadConfig();
	public String appUrl=readconfig.getApplicationUrl();
//	public String appemail=readconfig.getEmailId();
//	public String apppass=readconfig.getPassword();
	public static WebDriver driver;
	public static Logger logger;

    @Parameters("browser")
	@BeforeMethod
	public void setUp(@Optional ("mailid")String browsername) {
    	logger=Logger.getLogger(FlightBooking_BaseClass.class);
    	PropertyConfigurator.configure("log4j.properties");
		switch (browsername) {
		case "chrome":
			System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+readconfig.getChromeLoaction());
